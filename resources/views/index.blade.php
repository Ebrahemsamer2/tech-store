...
@section('content')
        ...
        <main class="main--wrapper">
            ...
            <!-- blog area start -->
            <section class="blog-area-three blog-area-two trending-product pb-50">
               <div class="container">
                   <div class="row align-items-center justify-content-between">
                        <div class="col-sm-12">
                            <div class="section-header section-header-three">
                                <div class="row align-items-center">
                                    <div class="col-xl-9 col-sm-6">
                                        <div class="product-section2">
                                            <h6 class="product--section__title2"><span>Latest News</span> From The Blog</h6>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="all__product--link text-right">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="blog-single mb-30">
                                <div class="image">
                                    <a href="#"><img src="{{ asset('assets/img/offer/offer__thumb__16.jpg') }}" class="img-fluid" alt=""></a>
                                </div>
                                <div class="content">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="blog-single mb-30">
                                <div class="image">
                                    <a href="#"><img src="{{ asset('assets/img/offer/offer__thumb__17.jpg') }}" class="img-fluid" alt=""></a>
                                </div>
                                <div class="content">
                                    <span class="dusty__gray-color f-400 pt-15">22 May 2020</span>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="blog-single mb-30">
                                <div class="image">
                                    <a href="#"><img src="{{ asset('assets/img/offer/offer__thumb__18.jpg') }}" class="img-fluid" alt=""></a>
                                </div>
                                <div class="content">
                                    <span class="dusty__gray-color f-400 pt-15">22 May 2020</span>
                                    <span class="blog-title"><a href="#" class="cod__black-color f-700">There are many variations of passages</a></span>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="blog-single mb-30">
                                <div class="image">
                                    <a href="#"><img src="{{ asset('assets/img/offer/offer__thumb__19.jpg') }}" class="img-fluid" alt=""></a>
                                </div>
                                <div class="content">
                                    <span class="dusty__gray-color f-400 pt-15">22 May 2020</span>
                                    <span class="blog-title"><a href="#" class="cod__black-color f-700">Contrary to Popular Belief Ipsum</a></span>
